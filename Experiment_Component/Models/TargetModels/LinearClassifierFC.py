...
class LinearClassifierFC(Model):
    """
    The LinearClassifierFC model learns on a representation of the given feature_extractor.
    ...
    def __init__(self, model_config, num_classes, input_shape, feature_extractor):
        ...
        """
        super(LinearClassifierFC, self).__init__()
        ...
        self.backbone = [InputLayer(input_shape=input_shape),
                         Flatten(),
